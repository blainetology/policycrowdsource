...
function PCAppFunctions() {
	...
	this.update_policy_section = function (policy_id, section_id, title, content) {
		if (typeof this.update_timeouts[section_id] === 'undefined') this.update_timeouts[section_id] = { timeout: null, title: title, content: content };
		if (this.update_timeouts[section_id]['timeout']) {
			clearTimeout(this.update_timeouts[section_id]['timeout']);
		}
		var that = this;
		this.update_timeouts[section_id]['timeout'] = setTimeout(function () {
