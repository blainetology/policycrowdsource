...
class PoliciesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Section::create(['content'=>"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.", 'policy_id'=>$policy->id, 'user_id'=>100000, 'display_order'=>1]); //400000
        Section::create(['content'=>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.", 'policy_id'=>$policy->id, 'user_id'=>100000, 'display_order'=>2]); //400000
        ...
        Section::create(['content'=>"At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga.", 'policy_id'=>$policy->id, 'user_id'=>100000, 'display_order'=>1]); //400000
        Section::create(['content'=>"Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", 'policy_id'=>$policy->id, 'user_id'=>100000, 'display_order'=>2]); //400000
        ...
        $policy = Policy::create(['name'=>'Breckenridge Townhomes CC&amp;R', 'short_synopsis'=>'Establishing new Covenants, Conditions, and Restrictions','full_synopsis'=>'Establishing new Covenants, Conditions, and Restrictions for the Breckenridge Townhomes Homeowners Association. The current ones are too limiting.', 'published'=>1, 'public'=>1, 'house_policy'=>0, 'rfp_id'=>30002]);
        Section::create(['content'=>"At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga.", 'policy_id'=>$policy->id, 'user_id'=>100000, 'display_order'=>1]); //400000
        Section::create(['content'=>"Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", 'policy_id'=>$policy->id, 'user_id'=>100000, 'display_order'=>2]); //400000
        Collaborator::create(['policy_id'=>$policy->id,'user_id'=>100001,'accepted'=>1,'owner'=>1,'admin'=>1,'editor'=>1,'reviewer'=>1,'viewer'=>1]);
