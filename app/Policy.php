...
class Policy extends Model
{
    ...
    protected $fillable = ['name','content','forked_id','numbering_pattern_id','rfp_id','public','published','short_synopsis','full_synopsis','rating','house_policy','starter_policy'];
